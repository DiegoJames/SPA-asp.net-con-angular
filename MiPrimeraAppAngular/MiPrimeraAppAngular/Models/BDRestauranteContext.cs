...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=ORELLANA\\SQLEXPRESS;Database=BDRestaurante;Integrated Security=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DetalleVentaReserva>(entity =>
            {
                ...
                entity.HasOne(d => d.IidreservaNavigation)
                    ...
                    .HasConstraintName("FK__DetalleVe__IIDRE__1273C1CD");
            });
            ...
            modelBuilder.Entity<Producto>(entity =>
            {
                ...
                entity.HasOne(d => d.IidmarcaNavigation)
                    ...
                    .HasConstraintName("FK__Producto__IIDMAR__164452B1");
            });
            ...
            modelBuilder.Entity<Reserva>(entity =>
            {
                ...
                entity.HasOne(d => d.IidpersonaregistraNavigation)
                    ...
                    .HasConstraintName("FK__Reserva__IIDPERS__182C9B23");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasOne(d => d.IidtipousuarioNavigation)
                    .WithMany(p => p.Usuario)
                    .HasForeignKey(d => d.Iidtipousuario)
                    .HasConstraintName("FK__Usuario__IIDTIPO__1B0907CE");
            });
        }
    }
}
